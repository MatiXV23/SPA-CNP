...
const inputClass = "border text-sm rounded-lg focus:ring-gray-600 focus:border-gray-600 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white"
export const creationFormTemplate = `
    ...
    <div class="relative p-4 rounded-lg shadow bg-gray-800 sm:p-5 max-w-4xl m-auto">
